...
export const EXERCISES: ExerciseDefinition[] = [
  ...
  { name: "Diamond Push-Up", category: "compound", equipment: "bodyweight", primaryMuscles: ["triceps"], secondaryMuscles: ["chest", "front-deltoids"], isStrengthStandard: false },
  ...
  { name: "Dumbbell Pullover", category: "isolation", equipment: "dumbbell", primaryMuscles: ["upper-back"], secondaryMuscles: ["chest", "triceps"], isStrengthStandard: false },
  ...
  { name: "Good Morning", category: "compound", equipment: "barbell", primaryMuscles: ["hamstring", "gluteal"], secondaryMuscles: ["lower-back"], isStrengthStandard: false },
